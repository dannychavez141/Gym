 ...
 <ul>
  ...
  <div id="content">
    ...
    <div id="c2"> 
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table width="285" align="center">
          <tr valign="baseline">
            <td width="104" align="right" nowrap="nowrap" bgcolor="#999966"> ID Usuario:</td>
    ...
    <hr />      <tr valign="baseline">
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right" bgcolor="#999966">Monto a Cancelar:</td>
            <td><input type="text" name="amount" value="<?php echo $row_Recordset1['amount']; ?>" size="25" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right" bgcolor="#999966">Estado</td>
            <td><p>
              <label>
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right" bgcolor="#999966">Plan(en dias) </td>
            <td><?php echo $row_Recordset1['plan']; ?></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">&nbsp;</td>
            <td><input type="submit" value="Pagar ahora" onclick="Gracias por su Pago"/></td>
          </tr>
        </table>
