...
<div id="logo"> 
 ...
 <ul>
  ...
  <div id="content">
    ...
    <div id="c1"><span class="txtuserreg"> <img src="../image/office.png" width="74" height="76" alt="us" />Detalles de Miembro:</span></div>
    <div id="c2"><hr /><p>
    <table border="0" align="center" cellpadding="4" cellspacing="2">
  <tr>
    <td width="66" bgcolor="#999966">ID Usuario</td>
    <td width="191"><?php echo $row_DetailRS1['userid']; ?></td>
  </tr>
  <tr>
    <td bgcolor="#999966">Nombres</td>
    <td><?php echo $row_DetailRS1['firstname']; ?></td>
  </tr>
  <tr>
    <td bgcolor="#999966">Apellidos</td>
    <td><?php echo $row_DetailRS1['lastname']; ?></td>
  </tr>
  <tr>
    <td bgcolor="#999966">Edad</td>
  ...
  <tr>
    <td bgcolor="#999966">Teléfono / Celular</td>
    <td><?php echo $row_DetailRS1['phone']; ?></td>
  </tr>
  <tr>
    <td bgcolor="#999966">Dirección</td>
    <td><?php echo $row_DetailRS1['address']; ?></td>
  </tr>
  <tr>
    <td bgcolor="#999966">Servicio</td>
    <td><?php echo $row_DetailRS1['service']; ?></td>
  </tr>
  <tr>
    <td bgcolor="#999966">Plan</td>
    <td><?php echo $row_DetailRS1['plan']; ?></td>
  </tr>
  <tr>
    <td bgcolor="#999966">Fecha Inscripción</td>
    <td><?php echo $row_DetailRS1['timestap']; ?></td>
  </tr>
  <tr>
    <td bgcolor="#999966">Monto Cancelado</td>
    <td><?php echo $row_DetailRS1['amount']; ?></td>
  </tr>
  <tr>
    <td bgcolor=>&nbsp;</td>
    <td><a href="myembers.php" class="kk">Volver</a></td>
  </tr>
    </table>
