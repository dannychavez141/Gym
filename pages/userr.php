...
<img src="../image/main.png" /><div id="logo"> 
 ...
 <ul>
  ...
  <div id="content">
    ...
    <div id="c1"><span class="txtuserreg"> <img src="../image/office.png" width="74" height="76" alt="us" />Registro de Usuario </span></div>
    <div id="c2">
     <fieldset>   <form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST"> <hr/><table width="394"  height="562" align="left"  >
        <tr>
          <td height="25" class="table" bgcolor="#999966" >Nombres</td>
          <td  > 
  ...
  <tr>
    <td width="136" height="25" class="table" bgcolor="#999966"  >Apellidos</td>
    <td width="327"  > 
      <input name="lname" type="text" required="required" id="lname"   />
       </td>
  </tr>
  <tr>
    <td height="25"  bgcolor="#669999" class="table">Edad</td>
    <td>
      <input name="agetxt" type="text" required="required" id="agetxt2"   />
    </td>
  </tr>
  <tr>
    <td height="25" bgcolor="#0066FF" class="table">Sexo</td>
    <td> 
  ...
  <tr>
    <td height="25" bgcolor="#9999CC" class="table">Teléfono /Celular:</td>
    <td> 
      <input name="phonetxt" type="text" required="required" id="agetxt"   />
          </td>
  </tr>
  <tr>
    <td height="25" bgcolor="#9999FF" class="table">Dirección</td>
    <td> 
      <input name="addresstxt" type="text" required="required" id="agetxt"  />
       </td>
  </tr>
  <tr>
    <td height="25" bgcolor="#99FFFF">Servicio</td>
    <td> 
  ...
  <tr>
    <td height="25" bgcolor="#999999">Fecha</td>
    <td> 
      <input name="datetime-local" type="datetime-local" required="required" id="datetime-local" />
      </td>
  </tr>
  <tr>
    <td height="25" bgcolor="#999966">Monto Cancelado</td>
    <td> 
  ...
  <tr>
    ...
    <td>  
        ...
        <select name="select" required="required" id="select">
          <option value="30" selected="selected">1 mes</option>
  ...
  <tr>
    <td height="25"> </td>
    <td><hr/><input type="submit" name="submit" id="submit" value="Guardar" /></td>
  </tr>
