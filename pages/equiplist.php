...
<img src="../image/main.png" /> <div id="logo"> 
 ...
 <ul>
  ...
  <div id="content">
    ...
    <div id="c1"><span class="txtuserreg"> <img src="../image/office.png" width="74" height="76" alt="us" />Lista Equipamento:</span></div>
    <div id="c2"><hr/><form action="" id="form1" method="post" name="form1">
     ...
     <br/>  <table border="0" align="center" cellpadding="7" cellspacing="7">
        <tr>
          <td bgcolor="#438C47">ID Equipo</td>
          <td bgcolor="#438C47">Nombre</td>
          <td bgcolor="#438C47">Vendedor</td>
           
          <td bgcolor="#438C47">Monto Pagado</td>
          <td bgcolor="#438C47">Teléfono/Celular</td>
          <td bgcolor="#438C47">Dirección</td>
          <td bgcolor="#438C47">Fecha</td>
          <td bgcolor="#CC9">&nbsp;</td>
        </tr>
        <?php do { ?>
        <tr>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><a href="equi.php" class="my">AGREGAR</a></td>
          <td>&nbsp;</td>
        </tr>
        
      </table> <span class="kk"><a href="<?php printf("%s?pageNum_eqp=%d%s", $currentPage, max(0, $pageNum_eqp - 1), $queryString_eqp); ?>" class="kk">Anterior</a></span><a href="<?php printf("%s?pageNum_eqp=%d%s", $currentPage, min($totalPages_eqp, $pageNum_eqp + 1), $queryString_eqp); ?>" class="kk">||Siguiente</a> 
      
<br />
 <br />     
Registros <?php echo ($startRow_eqp + 1) ?> de <?php echo min($startRow_eqp + $maxRows_eqp, $totalRows_eqp) ?> a <?php echo $totalRows_eqp ?>
      <hr/>
