  ...
  <div id="content">
    ...
    <br/>
      <table width="772" border="0" cellpadding="4" cellspacing="4">
        <tbody>
          <tr>
            <td width="100" bgcolor="#2F6F2E">ID Usuario</td>
            <td width="100" bgcolor="#2F6F2E">Nombres</td>
            <td width="100" bgcolor="#2F6F2E">Apellidos</td>
            <td width="100" bgcolor="#2F6F2E">Servicio</td>
            <td width="100" bgcolor="#3D7A79">Estado</td>
            <td width="100" bgcolor="#2F6F2E">Plan(en dias)</td>
          </tr>
         <?php do { ?> <tr>
...
<td>  <?php echo $row_Recordset1['plan']; ?> </td>
	  ...
	  <p> Archivos <?php echo ($startRow_Recordset1 + 1) ?> de <?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?> a <?php echo $totalRows_Recordset1 ?> </p><hr/>
